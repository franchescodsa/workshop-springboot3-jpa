...
public class User  implements Serializable{
	...
	@JsonIgnore/*
	A anotação @JsonIgnore é usada para impedir que determinados campos de uma classe sejam serializados ou 
	desserializados quando a classe é convertida para JSON. 
	Isso é útil, por exemplo, para evitar expor informações sensíveis (como senhas) em respostas JSON.*/
